"""agentbuilder.testing: official test utilities for testing agents built on this framework, with no cost and no network.
...
top-level `agentbuilder.__all__`; import on demand via `from agentbuilder.testing import ScriptedLLM`.
