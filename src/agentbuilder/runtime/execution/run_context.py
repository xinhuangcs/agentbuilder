"""agentbuilder.runtime.execution.run_context: run-level context (trace correlation + run governance), propagated via contextvars.
...
_current: contextvars.ContextVar[Optional[_RunContext]] = contextvars.ContextVar(
    "agentbuilder_run_context", default=None)
