"""agentbuilder.runtime.guardrails: guardrail interface and generic implementation.
...
concrete rules are app business logic: agentbuilder only provides the interface plus a CallableGuardrail
