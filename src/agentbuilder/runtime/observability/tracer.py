"""agentbuilder.runtime.observability.tracer: minimal tracer (Tracer).
...
_logger = logging.getLogger(__name__)   # Exporter-failure warnings go through this (the library configures no handler, leaving it to the host; see the NullHandler in agentbuilder/__init__).
    ...
    def __init__(self, *, redact: bool = True, max_value_len: int = 200,
        ...
        Args:
            ...
            extra_secret_keys: Additional secret key names contributed by the app (substring match, case-insensitive):
                ...
                business-specific sensitive fields are declared here (upholding §8 "business concepts do not enter agentbuilder").
