"""agentbuilder.runtime.harness: the cross-cutting service layer (harness).
...
_logger = logging.getLogger(__name__)   # Warnings about truncated LLM output go here (the library installs no handler, the host takes over; see the NullHandler in agentbuilder/__init__)
