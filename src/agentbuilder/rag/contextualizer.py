"""agentbuilder.rag.contextualizer: Contextual Retrieval, adding context to chunks before ingestion.
...
# The default prompt is now provided by the central registry agentbuilder.prompts (single source of truth); this constant is a convenience alias snapshotted at import time (does not follow overrides).
