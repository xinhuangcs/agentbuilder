"""agentbuilder.rag.rag_tool: wrap RAG as a tool so an Agent can manage a knowledge base and answer questions (agentic RAG).

Built on agentbuilder.tools.base.Tool. Actions: add_text / add_document / search / ask / stats.
