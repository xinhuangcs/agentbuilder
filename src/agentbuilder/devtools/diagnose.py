"""agentbuilder.devtools.diagnose: the LLM half of Trace Detective.
...
diagnosis runs through a plain agentbuilder Agent with output_schema (pydantic-validated structured output),
