"""agentbuilder.retrieval.backends.openai_embedder: OpenAI implementation of text embedding.
...
class OpenAIEmbedder(Embedder):
    ...
    Consistent with the LLM clients in agentbuilder.core: reuses the openai package, builds the client lazily,
