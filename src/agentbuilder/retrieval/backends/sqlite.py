"""agentbuilder.retrieval.backends.sqlite: complete local SQLite retrieval backend.
...
plus its SQL helpers in `../scope.py` / `../scope_sql.py` (shared across all of agentbuilder). To use a non-SQLite
