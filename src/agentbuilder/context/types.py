"""agentbuilder.context.types: config and source interface for context engineering.
...
class ContextSource(ABC):
    ...
    def fetch(self, query: str, scope=None) -> List[RetrievalResult]:
        ...
        use user/app; agentbuilder only threads scope down to here and does not prescribe its semantics.
        """
