"""agentbuilder.memory: memory subsystem (built on top of the agentbuilder.retrieval base).
...
Provided:
    ...
    - Memory: semantic memory combining the source-of-truth store with the retrieval base;
      ...
      (the source-to-derived-index sync seam IndexSync / SyncIndexSync is shared with RAG and lives in agentbuilder.retrieval).
