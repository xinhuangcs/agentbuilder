"""agentbuilder.memory.smart_writer: Mem0-style smart writing.
...
# Default prompts now come from the central registry agentbuilder.prompts (single source of truth); these two
...
class SmartWriter:
    ...
    def __init__(self, memory: Memory, llm: LLMClient, *, similar_k: Optional[int] = None, fail_open: bool = True,
        ...
        Args:
            ...
            prompts: Optional prompt registry (PromptRegistry, see agentbuilder.prompts); defaults to the
