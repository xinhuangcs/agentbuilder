"""agentbuilder.agents.agent: Agent, the framework's single "model calls tools in a loop" execution primitive.
...
from agentbuilder.core import LLMClient, Message, TokenCounter, count_tokens
from agentbuilder.core.aio import iter_sync
from agentbuilder.runtime.execution import ExecutionState
from agentbuilder.runtime.harness import HarnessConfig
from agentbuilder.runtime.hitl import ApprovalRequired, PendingAction
from agentbuilder.runtime.hooks import afire
...
if TYPE_CHECKING:                       # Type hints only; not imported at runtime (keeps the base Agent from pulling in the context / retrieval stack)
    from agentbuilder.context import ContextBuilder, ContextSource
    from agentbuilder.context.history_compactor import HistoryCompactor
    from agentbuilder.context.types import ReducerConfig
    from agentbuilder.tools import ConfirmCallback
    ...
    def __init__(self, name: str, llm: LLMClient, system_prompt: Optional[str] = None, *,
        ...
        Args:
            ...
            confirm: Confirmation callback for high-risk tools (tool, params) -> bool; if omitted, it
                ...
                In CLI / teaching scenarios pass agentbuilder.runtime.cli_confirm explicitly for command-line
