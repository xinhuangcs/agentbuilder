"""agentbuilder.agents.base: BaseAgent, the shared base for all agents.
...
class BaseAgent:
    ...
    def __init__(self, name: str, llm: LLMClient, system_prompt: Optional[str] = None, *,
        ...
        Args:
            ...
            checkpoint_store: Optional execution-state checkpoint store (CheckpointStore,
                agentbuilder.runtime.execution). Attaching one enables execution-state persistence,
            ...
            hooks: Optional list of lifecycle hooks (Hook, agentbuilder.runtime.hooks); observe-only.
            ...
            run_policy: Optional run governance (RunPolicy, agentbuilder.runtime.execution). When
        ...
        # Prompt registry (PromptRegistry, see agentbuilder.prompts): this strategy's built-in
    ...
    def get_prompts(self) -> dict:
        ...
        called, and what they look like, then decide which to override (see agentbuilder/doc/prompts.md).
        """
