"""agentbuilder.core.adapters.tool_emulation: tool-call translation shim for models without function calling (bidirectional translation at the adapter layer).
