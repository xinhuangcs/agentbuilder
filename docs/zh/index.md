...
无需任何配置即可运行（无需 API key，无需联网），与 [`examples/01_quickstart.py`](https://github.com/xinhuangcs/agentbuilder/blob/main/examples/01_quickstart.py) 中随包提供的代码完全一致：
...
1.0 之前：次版本号可能引入破坏性变更，修订版本号只做修复。请锁定 `agentbuilder>=0.1,<0.2`。参见 [更新日志](https://github.com/xinhuangcs/agentbuilder/blob/main/CHANGELOG.md)。
